...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance PSCIHandler_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance PSCIHandler_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition PSCIHandler_fresh : compatlayer (cdata RData) :=
      _psci_rsi ↦ gensem psci_rsi_spec
      .

    Definition PSCIHandler_passthrough : compatlayer (cdata RData) :=
    ...
    Definition PSCIHandler := PSCIHandler_fresh ⊕ PSCIHandler_passthrough.
