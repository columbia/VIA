...
Require Import TableDataSMC.Code.smc_rtt_unmap.

Require Import TableDataSMC.LowSpecs.smc_rtt_unmap.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_table_unmap3: block.
    Hypothesis h_table_unmap3_s : Genv.find_symbol ge _table_unmap3 = Some b_table_unmap3.
    Hypothesis h_table_unmap3_p : Genv.find_funct_ptr ge b_table_unmap3
                                  = Some (External (EF_external _table_unmap3
                                                   (signature_of_type (Tcons Tptr (Tcons tulong (Tcons tulong Tnil))) tulong cc_default))
                                         (Tcons Tptr (Tcons tulong (Tcons tulong Tnil))) tulong cc_default).
    Local Opaque table_unmap3_spec.
    ...
    Lemma smc_rtt_unmap_body_correct:
      forall m d d' env le rd_addr map_addr level res
             ...
             (Hspec: smc_rtt_unmap_spec0 (VZ64 (Int64.unsigned rd_addr)) (VZ64 (Int64.unsigned map_addr)) (VZ64 (Int64.unsigned level)) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) smc_rtt_unmap_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec smc_rtt_unmap_body; eexists; solve_proof_low.
    Qed.
