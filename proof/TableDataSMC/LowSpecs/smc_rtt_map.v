...
Section SpecLow.
  ...
  Definition smc_rtt_map_spec0 (rd_addr: Z64) (map_addr: Z64) (level: Z64) (adt: RData) : option (RData * Z64) :=
    ...
    | VZ64 _rd_addr, VZ64 _map_addr, VZ64 _level =>
      ...
      if (_ret =? 0) then
        ...
        if (_t'4 =? 1) then
          ...
          when' _ret, adt == table_map3_spec (_g_rd_base, _g_rd_ofst) (VZ64 _map_addr) (VZ64 _level) adt;
          rely is_int64 _ret;
