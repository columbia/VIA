          ...
          (Ssequence
            ...
            (Sifthenelse (Ebinop Oeq (Etempvar _t'4 tuint)
              ...
              (Ssequence
                (Ssequence
                  (Scall (Some _t'3)
                    (Evar _table_destroy3 (Tfunction
                                            (Tcons
                                              (tptr Tvoid)
                                              (Tcons tulong
                                                (Tcons tulong
                    ...
                    ((Etempvar _g_rd (tptr Tvoid)) ::
                     ...
                     (Etempvar _rtt_addr tulong) :: (Etempvar _level tulong) ::
                     nil))
