...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance PSCIAux2_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance PSCIAux2_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance psci_cpu_on_target_inv: PreservesInvariants psci_cpu_on_target_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance psci_lookup_target_inv: PreservesInvariants psci_lookup_target_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance system_off_reboot_inv: PreservesInvariants system_off_reboot_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition PSCIAux2_fresh : compatlayer (cdata RData) :=
    ...
    Definition PSCIAux2_passthrough : compatlayer (cdata RData) :=
    ...
    Definition PSCIAux2 := PSCIAux2_fresh ⊕ PSCIAux2_passthrough.
