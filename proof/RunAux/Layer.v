...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RunAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RunAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance emulate_mmio_read_inv: PreservesInvariants emulate_mmio_read_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RunAux_fresh : compatlayer (cdata RData) :=
    ...
    Definition RunAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RunAux := RunAux_fresh ⊕ RunAux_passthrough.
