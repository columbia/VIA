...
Require Import TableDataOpsRef3.Code.table_create3.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_table_create2: block.
    Hypothesis h_table_create2_s : Genv.find_symbol ge _table_create2 = Some b_table_create2.
    Hypothesis h_table_create2_p : Genv.find_funct_ptr ge b_table_create2
                                   = Some (External (EF_external _table_create2
                                                    (signature_of_type (Tcons Tptr (Tcons tulong (Tcons tulong (Tcons Tptr (Tcons tulong Tnil))))) tulong cc_default))
                                          (Tcons Tptr (Tcons tulong (Tcons tulong (Tcons Tptr (Tcons tulong Tnil))))) tulong cc_default).
    Local Opaque table_create2_spec.

    Lemma table_create3_body_correct:
      forall m d d' env le g_rd_base g_rd_offset map_addr level g_rtt_base g_rtt_offset rtt_addr res
             ...
             (Hspec: table_create3_spec0 (g_rd_base, g_rd_offset) (VZ64 (Int64.unsigned map_addr)) (VZ64 (Int64.unsigned level)) (g_rtt_base, g_rtt_offset) (VZ64 (Int64.unsigned rtt_addr)) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) table_create3_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec table_create3_body; eexists; solve_proof_low.
    Qed.
