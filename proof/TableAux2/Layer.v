...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance TableAux2_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance TableAux2_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance table_create_init_vacant_inv: PreservesInvariants table_create_init_vacant_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance table_create_init_absent_inv: PreservesInvariants table_create_init_absent_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance table_create_init_present_inv: PreservesInvariants table_create_init_present_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance table_delete_inv: PreservesInvariants table_delete_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance table_fold_inv: PreservesInvariants table_fold_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition TableAux2_fresh : compatlayer (cdata RData) :=
    ...
    Definition TableAux2_passthrough : compatlayer (cdata RData) :=
    ...
    Definition TableAux2 := TableAux2_fresh ⊕ TableAux2_passthrough.
