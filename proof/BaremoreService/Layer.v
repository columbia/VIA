...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance BaremoreService_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance BaremoreService_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance asc_mark_realm_inv: PreservesInvariants asc_mark_realm_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance asc_mark_nonsecure_inv: PreservesInvariants asc_mark_nonsecure_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition BaremoreService_fresh : compatlayer (cdata RData) :=
      _asc_mark_realm ↦ gensem asc_mark_realm_spec
        ⊕ _asc_mark_nonsecure ↦ gensem asc_mark_nonsecure_spec
      .

    Definition BaremoreService_passthrough : compatlayer (cdata RData) :=
    ...
    Definition BaremoreService := BaremoreService_fresh ⊕ BaremoreService_passthrough.
