...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance AbsAccessor_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance AbsAccessor_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance ptr_is_err_inv: PreservesInvariants ptr_is_err_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance granule_addr_inv: PreservesInvariants granule_addr_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance addr_to_granule_inv: PreservesInvariants addr_to_granule_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance get_g_data_rd_inv: PreservesInvariants get_g_data_rd_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance get_rd_measurement_inv: PreservesInvariants get_rd_measurement_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance get_rec_dispose_pending_inv: PreservesInvariants get_rec_dispose_pending_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_rvic_mask_bits_inv: PreservesInvariants set_rvic_mask_bits_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_retval_inv: PreservesInvariants set_retval_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_wi_last_level_inv: PreservesInvariants set_wi_last_level_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance get_rec_params_gprs_inv: PreservesInvariants get_rec_params_gprs_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance get_rec_params_pc_inv: PreservesInvariants get_rec_params_pc_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_rec_dispose_addr_inv: PreservesInvariants set_rec_dispose_addr_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_rec_run_disposed_addr_inv: PreservesInvariants set_rec_run_disposed_addr_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_psci_result_x1_inv: PreservesInvariants set_psci_result_x1_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_psci_result_x2_inv: PreservesInvariants set_psci_result_x2_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_psci_result_x3_inv: PreservesInvariants set_psci_result_x3_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance set_rvic_result_x2_inv: PreservesInvariants set_rvic_result_x2_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_rvic_result_x3_inv: PreservesInvariants set_rvic_result_x3_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance ns_buffer_read_realm_params_inv: PreservesInvariants ns_buffer_read_realm_params_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance max_ipa_size_inv: PreservesInvariants max_ipa_size_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance region_is_contained_inv: PreservesInvariants region_is_contained_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance check_granule_idx_inv: PreservesInvariants check_granule_idx_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance addr_to_gidx_inv: PreservesInvariants addr_to_gidx_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance find_spinlock_inv: PreservesInvariants find_spinlock_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance spinlock_acquire_inv: PreservesInvariants spinlock_acquire_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance spinlock_release_inv: PreservesInvariants spinlock_release_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance get_pas_inv: PreservesInvariants get_pas_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_pas_inv: PreservesInvariants set_pas_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance tlbi_by_pa_inv: PreservesInvariants tlbi_by_pa_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance baremore_enter_inv: PreservesInvariants baremore_enter_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance baremore_to_ns_inv: PreservesInvariants baremore_to_ns_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance baremore_to_rmm_inv: PreservesInvariants baremore_to_rmm_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance baremore_return_rmm_inv: PreservesInvariants baremore_return_rmm_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance get_monitor_call_arg_inv: PreservesInvariants get_monitor_call_arg_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance get_monitor_call_ret_inv: PreservesInvariants get_monitor_call_ret_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance set_monitor_call_inv: PreservesInvariants set_monitor_call_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance measurement_extend_rec_header_inv: PreservesInvariants measurement_extend_rec_header_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance measurement_extend_rec_regs_inv: PreservesInvariants measurement_extend_rec_regs_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance measurement_extend_rec_pstate_inv: PreservesInvariants measurement_extend_rec_pstate_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance measurement_extend_rec_sysregs_inv: PreservesInvariants measurement_extend_rec_sysregs_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition AbsAccessor_fresh : compatlayer (cdata RData) :=
      _assert_cond ↦ gensem assert_cond_spec
        ...
        ⊕ _addr_to_granule ↦ gensem addr_to_granule_spec
        ...
        ⊕ _get_g_data_rd ↦ gensem get_g_data_rd_spec
        ...
        ⊕ _get_rd_measurement ↦ gensem get_rd_measurement_spec
        ...
        ⊕ _get_rec_dispose_pending ↦ gensem get_rec_dispose_pending_spec
        ...
        ⊕ _set_retval ↦ gensem set_retval_spec
        ...
        ⊕ _set_wi_last_level ↦ gensem set_wi_last_level_spec
        ...
        ⊕ _set_psci_result_x1 ↦ gensem set_psci_result_x1_spec
        ⊕ _set_psci_result_x2 ↦ gensem set_psci_result_x2_spec
        ⊕ _set_psci_result_x3 ↦ gensem set_psci_result_x3_spec
        ...
        ⊕ _set_rvic_result_x2 ↦ gensem set_rvic_result_x2_spec
        ⊕ _set_rvic_result_x3 ↦ gensem set_rvic_result_x3_spec
        ...
        ⊕ _region_is_contained ↦ gensem region_is_contained_spec
    ...
    Definition AbsAccessor_passthrough : compatlayer (cdata RData) :=
      ∅.

    Definition AbsAccessor := AbsAccessor_fresh ⊕ AbsAccessor_passthrough.
