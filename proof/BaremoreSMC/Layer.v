...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance BaremoreSMC_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance BaremoreSMC_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition BaremoreSMC_fresh : compatlayer (cdata RData) :=
      _smc_mark_realm ↦ gensem smc_mark_realm_spec
        ⊕ _smc_mark_nonsecure ↦ gensem smc_mark_nonsecure_spec
      .

    Definition BaremoreSMC_passthrough : compatlayer (cdata RData) :=
    ...
    Definition BaremoreSMC := BaremoreSMC_fresh ⊕ BaremoreSMC_passthrough.
