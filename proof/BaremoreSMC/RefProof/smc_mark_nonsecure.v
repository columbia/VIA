...
Require Import BaremoreSMC.Specs.smc_mark_nonsecure.
...
Section Refine.
  ...
  Lemma smc_mark_nonsecure_spec_exists:
    forall habd habd'  labd addr
           (Hspec: smc_mark_nonsecure_spec addr habd = Some habd')
            (Hrel: relate_RData habd labd),
    exists labd', smc_mark_nonsecure_spec0 addr labd = Some labd' /\ relate_RData habd' labd'.
  Proof.
    Local Transparent Z.land Z.add.
    intros. destruct Hrel. inv id_rdata.
    unfold smc_mark_nonsecure_spec0, smc_mark_nonsecure_spec in *.
