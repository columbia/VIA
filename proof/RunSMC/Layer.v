...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RunSMC_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RunSMC_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition RunSMC_fresh : compatlayer (cdata RData) :=
      _smc_rec_run ↦ gensem smc_rec_run_spec
      .

    Definition RunSMC_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RunSMC := RunSMC_fresh ⊕ RunSMC_passthrough.
