...
Require Import RealmSyncHandlerAux.Code.handle_icc_el1_sysreg_trap.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma handle_icc_el1_sysreg_trap_body_correct:
      forall m d d' env le rec_base rec_offset esr
             ...
             (Hspec: handle_icc_el1_sysreg_trap_spec0 (rec_base, rec_offset) (VZ64 (Int64.unsigned esr)) d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) handle_icc_el1_sysreg_trap_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec handle_icc_el1_sysreg_trap_body; eexists; solve_proof_low.
    Qed.
