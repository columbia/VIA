...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RealmSyncHandlerAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RealmSyncHandlerAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance access_in_par_inv: PreservesInvariants access_in_par_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance get_write_value_inv: PreservesInvariants get_write_value_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_id_sysreg_trap_inv: PreservesInvariants handle_id_sysreg_trap_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_timer_sysreg_trap_inv: PreservesInvariants handle_timer_sysreg_trap_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_icc_el1_sysreg_trap_inv: PreservesInvariants handle_icc_el1_sysreg_trap_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RealmSyncHandlerAux_fresh : compatlayer (cdata RData) :=
    ...
    Definition RealmSyncHandlerAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RealmSyncHandlerAux := RealmSyncHandlerAux_fresh ⊕ RealmSyncHandlerAux_passthrough.
