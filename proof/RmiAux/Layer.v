...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RmiAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RmiAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance init_rec_sysregs_inv: PreservesInvariants init_rec_sysregs_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance init_common_sysregs_inv: PreservesInvariants init_common_sysregs_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RmiAux_fresh : compatlayer (cdata RData) :=
    ...
    Definition RmiAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RmiAux := RmiAux_fresh ⊕ RmiAux_passthrough.
