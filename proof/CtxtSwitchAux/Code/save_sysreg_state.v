...
Definition _t'7 := 38%positive.
Definition _t'8 := 39%positive.
Definition _t'9 := 40%positive.

Definition save_sysreg_state_body :=
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
...
Definition f_save_sysreg_state := {|
  fn_return := tvoid;
  ...
  fn_temps := ((_t'37, tulong) :: (_t'36, tulong) :: (_t'35, tulong) ::
               ...
               (_t'1, tulong) :: nil);
  fn_body := save_sysreg_state_body
|}.
