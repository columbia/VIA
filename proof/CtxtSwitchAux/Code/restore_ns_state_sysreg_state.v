...
Definition restore_ns_state_sysreg_state_body :=
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
    ...
    (Ssequence
      ...
      (Ssequence
        (Ssequence
          (Scall (Some _t'3)
            (Evar _get_ns_state (Tfunction (Tcons tuint Tnil) tulong
                                  cc_default))
              ...
              (Ssequence
                ...
                (Ssequence
                  ...
                  (Ssequence
                    (Ssequence
                      (Scall (Some _t'9)
                        (Evar _get_ns_state (Tfunction (Tcons tuint Tnil)
                                              tulong cc_default))
...
Definition f_restore_ns_state_sysreg_state := {|
  fn_return := tvoid;
  ...
  fn_body := restore_ns_state_sysreg_state_body
|}.
