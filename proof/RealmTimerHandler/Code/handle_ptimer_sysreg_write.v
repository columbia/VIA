...
Definition handle_ptimer_sysreg_write_body :=
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        ...
        (Ssequence
          (Sifthenelse (Ebinop Oeq (Etempvar _ec tuint)
            ...
            (Scall None
              (Evar _sysreg_write (Tfunction (Tcons tuint (Tcons tulong Tnil))
                                    tvoid cc_default))
              ((Econst_int (Int.repr 34) tuint) :: (Etempvar _val tulong) ::
               nil))
            (Sifthenelse (Ebinop Oeq (Etempvar _ec tuint)
                           (Econst_long (Int64.repr 3340292) tulong) tint)
              (Ssequence
                (Scall None
                  (Evar _set_rec_ptimer_masked (Tfunction
                                                 (Tcons
                                                   (tptr Tvoid)
          ...
          (Ssequence
            (Ssequence
              ...
              (Sset _cntp_ctl (Etempvar _t'3 tulong)))
            (Ssequence
              (Ssequence
                (Scall (Some _t'6)
                  (Evar _get_rec_ptimer_masked (Tfunction
                                                 (Tcons
                                                   (tptr Tvoid)
                    ...
                    (Ssequence
                      ...
                      (Scall None
                        ...
                        ((Etempvar _rec (tptr Tvoid)) ::
                         ...
                         (Ebinop Oor (Etempvar _t'4 tulong)
                           (Econst_long (Int64.repr 2048) tulong) tulong) ::
                         nil)))
                    (Ssequence
                      (Scall (Some _t'5)
                        (Evar _get_rec_sysregs (Tfunction
