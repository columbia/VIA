...
Definition handle_vtimer_sysreg_read_body :=
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
      ...
      (Sifthenelse (Ebinop Oeq (Etempvar _ec tuint)
        ...
        (Ssequence
          (Scall (Some _t'2)
            ...
            ((Econst_int (Int.repr 37) tuint) :: nil))
          (Scall None
          ...
          (Sifthenelse (Ebinop Oeq (Etempvar _ec tuint)
            ...
            (Ssequence
              (Scall (Some _t'6)
                (Evar _sysreg_read (Tfunction (Tcons tuint Tnil) tulong
                                     cc_default))
                ((Econst_int (Int.repr 36) tuint) :: nil))
              (Scall None
                (Evar _set_rec_regs (Tfunction
                                      (Tcons (tptr Tvoid)
                                        (Tcons tuint (Tcons tulong Tnil)))
...
Definition f_handle_vtimer_sysreg_read := {|
  fn_return := tvoid;
  ...
  fn_body := handle_vtimer_sysreg_read_body
|}.
