...
Require Import RealmTimerHandler.Code.handle_vtimer_sysreg_write.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_set_rec_vtimer_masked: block.
    Hypothesis h_set_rec_vtimer_masked_s : Genv.find_symbol ge _set_rec_vtimer_masked = Some b_set_rec_vtimer_masked.
    Hypothesis h_set_rec_vtimer_masked_p : Genv.find_funct_ptr ge b_set_rec_vtimer_masked
                                           = Some (External (EF_external _set_rec_vtimer_masked
                                                            (signature_of_type (Tcons Tptr (Tcons tuint Tnil)) tvoid cc_default))
                                                  (Tcons Tptr (Tcons tuint Tnil)) tvoid cc_default).
    Local Opaque set_rec_vtimer_masked_spec.
    ...
    Variable b_get_rec_vtimer_masked: block.
    Hypothesis h_get_rec_vtimer_masked_s : Genv.find_symbol ge _get_rec_vtimer_masked = Some b_get_rec_vtimer_masked.
    Hypothesis h_get_rec_vtimer_masked_p : Genv.find_funct_ptr ge b_get_rec_vtimer_masked
                                           = Some (External (EF_external _get_rec_vtimer_masked
                                                            (signature_of_type (Tcons Tptr Tnil) tuint cc_default))
                                                  (Tcons Tptr Tnil) tuint cc_default).
    Local Opaque get_rec_vtimer_masked_spec.

    Variable b_get_rec_vtimer: block.
    Hypothesis h_get_rec_vtimer_s : Genv.find_symbol ge _get_rec_vtimer = Some b_get_rec_vtimer.
    Hypothesis h_get_rec_vtimer_p : Genv.find_funct_ptr ge b_get_rec_vtimer
                                    = Some (External (EF_external _get_rec_vtimer
                                                     (signature_of_type (Tcons Tptr Tnil) Tptr cc_default))
                                           (Tcons Tptr Tnil) Tptr cc_default).
    Local Opaque get_rec_vtimer_spec.
    ...
    Variable b_set_rec_vtimer_asserted: block.
    Hypothesis h_set_rec_vtimer_asserted_s : Genv.find_symbol ge _set_rec_vtimer_asserted = Some b_set_rec_vtimer_asserted.
    Hypothesis h_set_rec_vtimer_asserted_p : Genv.find_funct_ptr ge b_set_rec_vtimer_asserted
                                             = Some (External (EF_external _set_rec_vtimer_asserted
                                                              (signature_of_type (Tcons Tptr (Tcons tuint Tnil)) tvoid cc_default))
                                                    (Tcons Tptr (Tcons tuint Tnil)) tvoid cc_default).
    Local Opaque set_rec_vtimer_asserted_spec.
    ...
    Lemma handle_vtimer_sysreg_write_body_correct:
      forall m d d' env le rec_base rec_offset esr
             ...
             (Hspec: handle_vtimer_sysreg_write_spec0 (rec_base, rec_offset) (VZ64 (Int64.unsigned esr)) d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) handle_vtimer_sysreg_write_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec handle_vtimer_sysreg_write_body; eexists; solve_proof_low.
    Qed.
