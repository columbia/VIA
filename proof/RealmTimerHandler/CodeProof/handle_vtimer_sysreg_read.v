...
Require Import RealmTimerHandler.Code.handle_vtimer_sysreg_read.

Require Import RealmTimerHandler.LowSpecs.handle_vtimer_sysreg_read.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma handle_vtimer_sysreg_read_body_correct:
      forall m d d' env le rec_base rec_offset esr
             ...
             (Hspec: handle_vtimer_sysreg_read_spec0 (rec_base, rec_offset) (VZ64 (Int64.unsigned esr)) d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) handle_vtimer_sysreg_read_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec handle_vtimer_sysreg_read_body; eexists; solve_proof_low.
    Qed.
