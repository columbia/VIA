...
Require Import RealmTimerHandler.Specs.handle_vtimer_sysreg_read.
...
Section Refine.
  ...
  Lemma handle_vtimer_sysreg_read_spec_exists:
    forall habd habd'  labd rec esr
      (Hspec: handle_vtimer_sysreg_read_spec rec esr habd = Some habd')
      (Hrel: relate_RData habd labd),
    exists labd', handle_vtimer_sysreg_read_spec0 rec esr labd = Some labd' /\ relate_RData habd' labd'.
  Proof.
    Local Opaque ptr_eq.
    intros. destruct Hrel. destruct rec.
    unfold handle_vtimer_sysreg_read_spec, handle_vtimer_sysreg_read_spec0 in *.
