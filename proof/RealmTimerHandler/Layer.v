...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RealmTimerHandler_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RealmTimerHandler_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance handle_vtimer_sysreg_write_inv: PreservesInvariants handle_vtimer_sysreg_write_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_ptimer_sysreg_write_inv: PreservesInvariants handle_ptimer_sysreg_write_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_vtimer_sysreg_read_inv: PreservesInvariants handle_vtimer_sysreg_read_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_ptimer_sysreg_read_inv: PreservesInvariants handle_ptimer_sysreg_read_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RealmTimerHandler_fresh : compatlayer (cdata RData) :=
    ...
    Definition RealmTimerHandler_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RealmTimerHandler := RealmTimerHandler_fresh ⊕ RealmTimerHandler_passthrough.
