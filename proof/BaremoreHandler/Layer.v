...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance BaremoreHandler_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance BaremoreHandler_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition BaremoreHandler_fresh : compatlayer (cdata RData) :=
      _el3_sync_lel ↦ gensem el3_sync_lel_spec
      .

    Definition BaremoreHandler_passthrough : compatlayer (cdata RData) :=
    ...
    Definition BaremoreHandler := BaremoreHandler_fresh ⊕ BaremoreHandler_passthrough.
