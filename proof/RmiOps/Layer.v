...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RmiOps_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RmiOps_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance granule_delegate_ops_inv: PreservesInvariants granule_delegate_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance granule_undelegate_ops_inv: PreservesInvariants granule_undelegate_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance realm_activate_ops_inv: PreservesInvariants realm_activate_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance realm_create_ops_inv: PreservesInvariants realm_create_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance realm_destroy_ops_inv: PreservesInvariants realm_destroy_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rec_create_ops_inv: PreservesInvariants rec_create_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rec_destroy_ops_inv: PreservesInvariants rec_destroy_ops_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RmiOps_fresh : compatlayer (cdata RData) :=
      _granule_delegate_ops ↦ gensem granule_delegate_ops_spec
    ...
    Definition RmiOps_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RmiOps := RmiOps_fresh ⊕ RmiOps_passthrough.
