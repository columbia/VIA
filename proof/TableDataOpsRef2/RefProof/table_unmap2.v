...
Require Import TableDataOpsRef2.Specs.table_unmap2.
...
Section Refine.
  ...
  Lemma table_unmap2_spec_exists:
    forall habd habd'  labd g_rd map_addr level res
           (Hspec: table_unmap2_spec g_rd map_addr level habd = Some (habd', res))
            (Hrel: relate_RData habd labd),
    exists labd', table_unmap2_spec0 g_rd map_addr level labd = Some (labd', res) /\ relate_RData habd' labd'.
  Proof.
    Local Opaque peq ptr_eq.
    intros. duplicate Hrel. destruct D. clear hrepl lrepl. destruct g_rd.
    unfold table_unmap2_spec, table_unmap2_spec0 in *.
