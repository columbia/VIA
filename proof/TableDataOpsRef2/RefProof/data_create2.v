...
Require Import TableDataOpsRef2.Specs.data_create2.
...
Section Refine.
  ...
  Lemma data_create2_spec_exists:
    forall habd habd'  labd g_rd data_addr map_addr g_data g_src res
           (Hspec: data_create2_spec g_rd data_addr map_addr g_data g_src habd = Some (habd', res))
            (Hrel: relate_RData habd labd),
    exists labd', data_create2_spec0 g_rd data_addr map_addr g_data g_src labd = Some (labd', res) /\ relate_RData habd' labd'.
  Proof.
    Local Opaque peq ptr_eq.
    intros. duplicate Hrel. destruct D. clear hrepl lrepl. destruct g_data, g_src, g_rd.
    unfold data_create2_spec, data_create2_spec0 in *.
