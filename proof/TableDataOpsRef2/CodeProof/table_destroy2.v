...
Require Import TableDataOpsRef2.Code.table_destroy2.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_table_destroy1: block.
    Hypothesis h_table_destroy1_s : Genv.find_symbol ge _table_destroy1 = Some b_table_destroy1.
    Hypothesis h_table_destroy1_p : Genv.find_funct_ptr ge b_table_destroy1
                                    = Some (External (EF_external _table_destroy1
                                                     (signature_of_type (Tcons Tptr (Tcons tulong (Tcons tulong (Tcons tulong Tnil)))) tulong cc_default))
                                           (Tcons Tptr (Tcons tulong (Tcons tulong (Tcons tulong Tnil)))) tulong cc_default).
    Local Opaque table_destroy1_spec.

    Lemma table_destroy2_body_correct:
      forall m d d' env le g_rd_base g_rd_offset map_addr rtt_addr level res
             ...
             (Hspec: table_destroy2_spec0 (g_rd_base, g_rd_offset) (VZ64 (Int64.unsigned map_addr)) (VZ64 (Int64.unsigned rtt_addr)) (VZ64 (Int64.unsigned level)) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) table_destroy2_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec table_destroy2_body; eexists; solve_proof_low.
    Qed.
