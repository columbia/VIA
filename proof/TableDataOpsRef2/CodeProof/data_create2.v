...
Require Import TableDataOpsRef2.Code.data_create2.

Require Import TableDataOpsRef2.LowSpecs.data_create2.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_data_create1: block.
    Hypothesis h_data_create1_s : Genv.find_symbol ge _data_create1 = Some b_data_create1.
    Hypothesis h_data_create1_p : Genv.find_funct_ptr ge b_data_create1
                                  = Some (External (EF_external _data_create1
    ...
    Local Opaque data_create1_spec.
    ...
    Lemma data_create2_body_correct:
      forall m d d' env le g_rd_base g_rd_offset data_addr map_addr g_data_base g_data_offset g_src_base g_src_offset res
             ...
             (Hspec: data_create2_spec0 (g_rd_base, g_rd_offset) (VZ64 (Int64.unsigned data_addr)) (VZ64 (Int64.unsigned map_addr)) (g_data_base, g_data_offset) (g_src_base, g_src_offset) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) data_create2_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec data_create2_body; eexists; solve_proof_low.
    Qed.
