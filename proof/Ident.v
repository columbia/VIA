...
Definition _get_rec_dispose_addr := 100000049%positive.
Definition _get_rec_pc := 100000050%positive.
Definition _get_rec_pstate := 100000051%positive.
Definition _get_rec_last_run_info_esr := 100000052%positive.
Definition _init_rec_read_only := 100000053%positive.
Definition _set_rec_g_rd := 100000054%positive.
Definition _set_rec_g_rec_list := 100000055%positive.
Definition _set_rec_par_base := 100000056%positive.
Definition _set_rec_par_end := 100000057%positive.
Definition _get_rec_runnable := 100000058%positive.
Definition _set_rec_runnable := 100000059%positive.
Definition _set_rec_regs := 100000060%positive.
Definition _set_rec_pc := 100000061%positive.
Definition _set_rec_pstate := 100000062%positive.
Definition _set_rvic_mask_bits := 100000063%positive.
Definition _set_rec_sysregs := 100000064%positive.
Definition _set_rec_common_sysregs := 100000065%positive.
Definition _set_rec_dispose_pending := 100000066%positive.
Definition _set_rec_last_run_info_esr := 100000067%positive.
Definition _get_rec_run_gprs := 100000068%positive.
Definition _get_rec_run_is_emulated_mmio := 100000069%positive.
Definition _get_rec_run_emulated_read_val := 100000070%positive.
Definition _pgte_read := 100000071%positive.
Definition _pgte_write := 100000072%positive.
Definition _link_table := 100000073%positive.
Definition _set_mapping := 100000074%positive.
Definition _set_retval := 100000075%positive.
Definition _realm_get_rec_entry := 100000076%positive.
Definition _realm_set_rec_entry := 100000077%positive.
Definition _get_wi_g_llt := 100000078%positive.
Definition _get_wi_index := 100000079%positive.
Definition _set_wi_last_level := 100000080%positive.
Definition _set_wi_g_llt := 100000081%positive.
Definition _set_wi_index := 100000082%positive.
Definition _get_realm_params_par_base := 100000083%positive.
Definition _get_realm_params_par_size := 100000084%positive.
Definition _get_realm_params_rtt_addr := 100000085%positive.
Definition _get_realm_params_rec_list_addr := 100000086%positive.
Definition _get_realm_params_measurement_algo := 100000087%positive.
Definition _get_rec_params_gprs := 100000088%positive.
Definition _get_rec_params_pc := 100000089%positive.
Definition _is_addr_in_par := 100000090%positive.
Definition _mpidr_is_valid := 100000091%positive.
Definition _mpidr_to_rec_idx := 100000092%positive.
Definition _addr_to_idx := 100000093%positive.
Definition _entry_to_phys := 100000094%positive.
Definition _entry_is_table := 100000095%positive.
Definition _is_rec_valid := 100000096%positive.
Definition _stage2_tlbi_ipa := 100000097%positive.
Definition _esr_srt := 100000098%positive.
Definition _access_mask := 100000099%positive.
Definition _esr_sign_extend := 100000100%positive.
Definition _access_len := 100000101%positive.
Definition _esr_sixty_four := 100000102%positive.
Definition _get_rec_regs := 100000103%positive.
Definition _get_rec_par_base := 100000104%positive.
Definition _get_rec_par_end := 100000105%positive.
Definition _set_rec_dispose_addr := 100000106%positive.
...
Definition _data_create_unknown := 100000341%positive.
Definition _data_destroy := 100000342%positive.
Definition _table_create1 := 100000343%positive.
Definition _table_destroy1 := 100000344%positive.
Definition _table_map1 := 100000345%positive.
Definition _table_unmap1 := 100000346%positive.
Definition _data_create1 := 100000347%positive.
Definition _data_create_unknown1 := 100000348%positive.
Definition _data_destroy1 := 100000349%positive.
Definition _table_create2 := 100000350%positive.
Definition _table_destroy2 := 100000351%positive.
Definition _table_map2 := 100000352%positive.
Definition _table_unmap2 := 100000353%positive.
Definition _data_create2 := 100000354%positive.
Definition _data_create_unknown2 := 100000355%positive.
Definition _data_destroy2 := 100000356%positive.
Definition _table_create3 := 100000357%positive.
Definition _table_destroy3 := 100000358%positive.
Definition _table_map3 := 100000359%positive.
Definition _table_unmap3 := 100000360%positive.
Definition _data_create3 := 100000361%positive.
Definition _data_create_unknown3 := 100000362%positive.
Definition _data_destroy3 := 100000363%positive.
Definition _smc_rtt_create := 100000364%positive.
Definition _smc_rtt_destroy := 100000365%positive.
Definition _smc_rtt_map := 100000366%positive.
Definition _smc_rtt_unmap := 100000367%positive.
Definition _smc_data_create := 100000368%positive.
Definition _smc_data_destroy := 100000369%positive.
Definition _smc_data_create_unknown := 100000370%positive.
Definition _handle_ns_smc := 100000371%positive.
Definition _rmm_handler := 100000372%positive.
Definition _realm_ns_step := 100000373%positive.
