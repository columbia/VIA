...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RVIC2_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RVIC2_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance find_lock_map_target_rec_inv: PreservesInvariants find_lock_map_target_rec_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_target_is_valid_inv: PreservesInvariants rvic_target_is_valid_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_is_pending_inv: PreservesInvariants rvic_is_pending_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_is_masked_inv: PreservesInvariants rvic_is_masked_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_set_flag_inv: PreservesInvariants rvic_set_flag_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_clear_flag_inv: PreservesInvariants rvic_clear_flag_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance is_trusted_intid_inv: PreservesInvariants is_trusted_intid_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
    ...
    Global Instance is_untrusted_intid_inv: PreservesInvariants is_untrusted_intid_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RVIC2_fresh : compatlayer (cdata RData) :=
    ...
    Definition RVIC2_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RVIC2 := RVIC2_fresh ⊕ RVIC2_passthrough.
