...
Section SpecLow.
  ...
  Definition rvic_is_pending_spec0 (rvic: Pointer) (intid: Z64) (adt: RData) : option Z :=
    match rvic, intid with
    | (_rvic_base, _rvic_ofst), VZ64 _intid =>
      when'' _bits_base, _bits_ofst == get_rvic_pending_bits_spec (_rvic_base, _rvic_ofst) adt;
