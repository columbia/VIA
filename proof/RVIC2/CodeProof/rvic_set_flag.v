...
Require Import RVIC2.Code.rvic_set_flag.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_atomic_bit_set_release_64: block.
    Hypothesis h_atomic_bit_set_release_64_s : Genv.find_symbol ge _atomic_bit_set_release_64 = Some b_atomic_bit_set_release_64.
    Hypothesis h_atomic_bit_set_release_64_p : Genv.find_funct_ptr ge b_atomic_bit_set_release_64
                                               = Some (External (EF_external _atomic_bit_set_release_64
                                                                (signature_of_type (Tcons Tptr (Tcons tuint Tnil)) tvoid cc_default))
                                                      (Tcons Tptr (Tcons tuint Tnil)) tvoid cc_default).
    Local Opaque atomic_bit_set_release_64_spec.
    ...
    Lemma rvic_set_flag_body_correct:
      forall m d d' env le intid bitmap_base bitmap_offset
             ...
             (Hspec: rvic_set_flag_spec0 (VZ64 (Int64.unsigned intid)) (bitmap_base, bitmap_offset) d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) rvic_set_flag_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec rvic_set_flag_body; eexists; solve_proof_low.
    Qed.
