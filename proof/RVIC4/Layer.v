...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RVIC4_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RVIC4_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance set_clear_masked_inv: PreservesInvariants set_clear_masked_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_set_pending_inv: PreservesInvariants rvic_set_pending_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_clear_pending_inv: PreservesInvariants rvic_clear_pending_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RVIC4_fresh : compatlayer (cdata RData) :=
      _set_clear_masked ↦ gensem set_clear_masked_spec
        ⊕ _rvic_set_pending ↦ gensem rvic_set_pending_spec
        ⊕ _rvic_clear_pending ↦ gensem rvic_clear_pending_spec
      .

    Definition RVIC4_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RVIC4 := RVIC4_fresh ⊕ RVIC4_passthrough.
