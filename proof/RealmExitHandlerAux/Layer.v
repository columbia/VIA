...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RealmExitHandlerAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RealmExitHandlerAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance handle_exception_sync_inv: PreservesInvariants handle_exception_sync_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_excpetion_irq_lel_inv: PreservesInvariants handle_excpetion_irq_lel_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RealmExitHandlerAux_fresh : compatlayer (cdata RData) :=
      _handle_exception_sync ↦ gensem handle_exception_sync_spec
        ⊕ _handle_excpetion_irq_lel ↦ gensem handle_excpetion_irq_lel_spec
      .

    Definition RealmExitHandlerAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RealmExitHandlerAux := RealmExitHandlerAux_fresh ⊕ RealmExitHandlerAux_passthrough.
