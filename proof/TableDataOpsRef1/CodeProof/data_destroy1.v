...
Require Import TableDataOpsRef1.Code.data_destroy1.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma data_destroy1_body_correct:
      forall m d d' env le g_rd_base g_rd_offset map_addr res
             ...
             (Hspec: data_destroy1_spec0 (g_rd_base, g_rd_offset) (VZ64 (Int64.unsigned map_addr)) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) data_destroy1_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec data_destroy1_body; eexists; solve_proof_low.
    Qed.
