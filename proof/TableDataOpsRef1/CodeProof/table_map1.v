...
Require Import TableDataOpsRef1.Code.table_map1.

Require Import TableDataOpsRef1.LowSpecs.table_map1.
  ...
  Section BodyProof.
    ...
    Lemma table_map1_body_correct:
      forall m d d' env le g_rd_base g_rd_offset map_addr level res
             ...
             (Hspec: table_map1_spec0 (g_rd_base, g_rd_offset) (VZ64 (Int64.unsigned map_addr)) (VZ64 (Int64.unsigned level)) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) table_map1_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec table_map1_body; eexists; solve_proof_low.
    Qed.
