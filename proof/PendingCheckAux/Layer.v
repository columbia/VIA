...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance PendingCheckAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance PendingCheckAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance check_timer_became_asserted_inv: PreservesInvariants check_timer_became_asserted_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition PendingCheckAux_fresh : compatlayer (cdata RData) :=
      _check_timer_became_asserted ↦ gensem check_timer_became_asserted_spec
      .

    Definition PendingCheckAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition PendingCheckAux := PendingCheckAux_fresh ⊕ PendingCheckAux_passthrough.
