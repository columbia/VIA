...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RVIC_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RVIC_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance rvic_test_flag_inv: PreservesInvariants rvic_test_flag_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RVIC_fresh : compatlayer (cdata RData) :=
    ...
    Definition RVIC_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RVIC := RVIC_fresh ⊕ RVIC_passthrough.
