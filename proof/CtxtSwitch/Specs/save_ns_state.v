...
Section Spec.
  ...
  Definition save_ns_state_spec  (adt: RData) : option RData :=
    rely regs_is_int64_dec (cpu_regs (priv adt));
    rely is_int64 (r_icc_sre_el2 (cpu_regs (priv adt)));
    Some adt {priv: (priv adt) {ns_regs_el2: (ns_regs_el2 (priv adt))
                                               ...
                                               {r_icc_sre_el2: r_icc_sre_el2 (cpu_regs (priv adt))}}}.
