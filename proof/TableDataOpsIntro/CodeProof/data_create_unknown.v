...
Require Import TableDataOpsIntro.Code.data_create_unknown.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma data_create_unknown_body_correct:
      forall m d d' env le g_rd_base g_rd_offset data_addr map_addr g_data_base g_data_offset res
             ...
             (Hspec: data_create_unknown_spec0 (g_rd_base, g_rd_offset) (VZ64 (Int64.unsigned data_addr)) (VZ64 (Int64.unsigned map_addr)) (g_data_base, g_data_offset) d = Some (d', VZ64 (Int64.unsigned res))),
           exists le', (exec_stmt ge env le ((m, d): mem) data_create_unknown_body E0 le' (m, d') (Out_return (Some (Vlong res, tulong)))).
    Proof.
      solve_code_proof Hspec data_create_unknown_body; eexists; solve_proof_low.
