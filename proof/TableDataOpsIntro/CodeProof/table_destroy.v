...
Require Import TableDataOpsIntro.Code.table_destroy.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Variable b_table_destroy_aux: block.
    Hypothesis h_table_destroy_aux_s : Genv.find_symbol ge _table_destroy_aux = Some b_table_destroy_aux.
    Hypothesis h_table_destroy_aux_p : Genv.find_funct_ptr ge b_table_destroy_aux
                                       = Some (External (EF_external _table_destroy_aux
                                                        (signature_of_type (Tcons Tptr (Tcons Tptr (Tcons Tptr (Tcons tulong (Tcons tulong (Tcons tulong Tnil)))))) tulong cc_default))
                                              (Tcons Tptr (Tcons Tptr (Tcons Tptr (Tcons tulong (Tcons tulong (Tcons tulong Tnil)))))) tulong cc_default).
    Local Opaque table_destroy_aux_spec.
