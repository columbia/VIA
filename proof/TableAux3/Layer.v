...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance TableAux3_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance TableAux3_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition TableAux3_fresh : compatlayer (cdata RData) :=
      _table_create_aux ↦ gensem table_create_aux_spec
        ⊕ _table_destroy_aux ↦ gensem table_destroy_aux_spec
      .

    Definition TableAux3_passthrough : compatlayer (cdata RData) :=
    ...
    Definition TableAux3 := TableAux3_fresh ⊕ TableAux3_passthrough.
