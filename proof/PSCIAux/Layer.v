...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance PSCIAux_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance PSCIAux_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance psci_reset_rec_inv: PreservesInvariants psci_reset_rec_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition PSCIAux_fresh : compatlayer (cdata RData) :=
      _psci_reset_rec ↦ gensem psci_reset_rec_spec
        ⊕ _find_lock_rec ↦ gensem find_lock_rec_spec
      .

    Definition PSCIAux_passthrough : compatlayer (cdata RData) :=
    ...
    Definition PSCIAux := PSCIAux_fresh ⊕ PSCIAux_passthrough.
