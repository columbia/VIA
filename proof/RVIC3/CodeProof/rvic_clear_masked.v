...
Require Import RVIC3.Code.rvic_clear_masked.
...
Section CodeProof.
  ...
  Section BodyProof.
    ...
    Lemma rvic_clear_masked_body_correct:
      forall m d d' env le rvic_base rvic_offset intid
             ...
             (Hspec: rvic_clear_masked_spec0 (rvic_base, rvic_offset) (VZ64 (Int64.unsigned intid)) d = Some d'),
           exists le', (exec_stmt ge env le ((m, d): mem) rvic_clear_masked_body E0 le' (m, d') Out_normal).
    Proof.
      solve_code_proof Hspec rvic_clear_masked_body; eexists; solve_proof_low.
    Qed.
