...
Require Import RVIC3.Specs.rvic_set_masked.
...
Section Refine.
  ...
  Lemma rvic_set_masked_spec_exists:
    forall habd habd'  labd rvic intid
      (Hspec: rvic_set_masked_spec rvic intid habd = Some habd')
      (Hrel: relate_RData habd labd),
    exists labd', rvic_set_masked_spec0 rvic intid labd = Some labd' /\ relate_RData habd' labd'.
  Proof.
    intros. inv Hrel. destruct rvic.
    unfold rvic_set_masked_spec, rvic_set_masked_spec0 in *.
