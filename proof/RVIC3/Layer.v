...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RVIC3_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RVIC3_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance validate_and_lookup_target_inv: PreservesInvariants validate_and_lookup_target_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance need_ns_notify_inv: PreservesInvariants need_ns_notify_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_set_masked_inv: PreservesInvariants rvic_set_masked_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance rvic_clear_masked_inv: PreservesInvariants rvic_clear_masked_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RVIC3_fresh : compatlayer (cdata RData) :=
    ...
    Definition RVIC3_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RVIC3 := RVIC3_fresh ⊕ RVIC3_passthrough.
