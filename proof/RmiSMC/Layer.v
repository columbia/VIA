...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RmiSMC_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RmiSMC_prf : CompatData RData.
    Proof.
  ...
  Section LayerDef.
    ...
    Definition RmiSMC_fresh : compatlayer (cdata RData) :=
    ...
    Definition RmiSMC_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RmiSMC := RmiSMC_fresh ⊕ RmiSMC_passthrough.
