...
Section Layer.
  ...
  Section InvDef.
    ...
    Global Instance RealmSyncHandler_ops : CompatDataOps RData :=
      {
  ...
  Section InvInit.
    ...
    Global Instance RealmSyncHandler_prf : CompatData RData.
    Proof.
  ...
  Section InvProof.
    ...
    Global Instance handle_data_abort_inv: PreservesInvariants handle_data_abort_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_instruction_abort_inv: PreservesInvariants handle_instruction_abort_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_realm_rsi_inv: PreservesInvariants handle_realm_rsi_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.

    Global Instance handle_sysreg_access_trap_inv: PreservesInvariants handle_sysreg_access_trap_spec.
    Proof.
      constructor; intros; simpl; eauto.
      constructor.
    Qed.
  ...
  Section LayerDef.
    ...
    Definition RealmSyncHandler_fresh : compatlayer (cdata RData) :=
    ...
    Definition RealmSyncHandler_passthrough : compatlayer (cdata RData) :=
    ...
    Definition RealmSyncHandler := RealmSyncHandler_fresh ⊕ RealmSyncHandler_passthrough.
